...
class ImageToText extends Anticaptcha implements interfaceAntiCaptchaTaskProtocol
{
    private $body;
    ...
    public function setFileAsBitstream($stream)
    {
        $this->body = base64_encode($stream);
        return true;
    }
    ...
    public function setFile($fileName)
    {
        ...
        return $this->setFileAsBitstream(file_get_contents($fileName));
    }
